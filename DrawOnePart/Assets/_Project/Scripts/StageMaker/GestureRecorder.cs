...
public class GestureRecorder : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        gestureRenderer.startColor = startColor;
        gestureRenderer.endColor = endColor;
        gestureRenderer.startWidth = startThickness;
        gestureRenderer.endWidth = endThickness;
    }
    ...
    public void Setup(string id)
    {
        ...
        else gl = new GestureLibrary(libraryToLoad, forceCopy);
    }
