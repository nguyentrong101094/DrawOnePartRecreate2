		...
		public void RaycastNow()
		{
			if (pointA != null && pointB != null)
			{
				...
				if (Physics.Raycast(ray, out hit, maxDistance, layers) == true)
				{
					...
					SubmitPoint(preview, priority, hit.collider, finalPosition, finalRotation, pressure, this);
...
namespace PaintIn3D
{
	...
	public class P3dHitBetween_Editor : P3dConnectablePoints_Editor<P3dHitBetween>
	{
		protected override void OnInspector()
		{
			...
			Target.HitCache.Inspector(Target.gameObject, true, true, false, Target.ConnectHits);
		}
	}
}
#endif